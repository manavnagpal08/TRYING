...
def load_ml_model():
    ...
    try:
        ...
        # Ensure ml_screening_model.pkl is trained with predict_proba capability (e.g., SVC(probability=True))
...
CUSTOM_STOP_WORDS = set([
    ...
    "interpersonal", "organizational", "time", "multitasking", "detail", "oriented", "independent", "proactive",
    "self", "starter", "results", "driven", "achievements", "accomplishments",
...
def extract_skills_from_text(text):
    ...
    # This prevents matching "data" and "science" separately if "data science" is present.
    ...
    for skill_phrase in SORTED_MASTER_SKILLS:
        ...
        # Ensure it's a multi-word skill OR a single-word skill that is NOT a stop word
...
def predict_match_ml(resume_embedding, job_description_embedding, ml_model):
    ...
    if ml_model and resume_embedding is not None and job_description_embedding is not None:
        ...
        # This assumes ml_model has a predict_proba method (e.g., SVC(probability=True))
...
if job_description_file:
    ...
    st.info("Please upload a Job Description to proceed with skill matching and resume analysis.")
...
if uploaded_resumes and job_description_file:
    ...
    if model and ml_model and t5_tokenizer and t5_model:
        # Removed the problematic 'if not jd_embedding:' line here
        ...
        for i, resume_file in enumerate(uploaded_resumes):
            ...
            match_proba = 0.0
            if jd_embedding is not None: # This check is sufficient
